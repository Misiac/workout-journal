...
--
-- Table structure for table `musclegroup_jointable`
--

DROP TABLE IF EXISTS `musclegroup_jointable`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `musclegroup_jointable` (
  ...
  CONSTRAINT `excercise_id` FOREIGN KEY (`excercise_id`) REFERENCES `exercises` (`id`)
