...
class ExerciseTypeRepositoryTest {
    ...
    void findExercisesByEquipmentCategories() {
        ...
        ExerciseType savedExercise = exerciseTypeRepository.findExercisesByEquipmentCategory("Dumbbell").get(0);
    ...
    void findExercisesByMuscleGroups() {
        ...
        ExerciseType savedExercise = exerciseTypeRepository.findExercisesByMuscleGroup("Shoulders", true).get(0);
